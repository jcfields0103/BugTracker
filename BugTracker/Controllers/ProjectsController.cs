...
namespace BugTracker.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            ViewBag.ProjectManagers = new MultiSelectList(allProjectManagers, "Id", "Email",currentProjectManagers);
            ...
            ViewBag.Submitters = new MultiSelectList(allSubmitters, "Id", "Email",currentSubmitters);
            ...
            ViewBag.Developers = new MultiSelectList(allDevelopers, "Id", "Email",currentDevelopers);
