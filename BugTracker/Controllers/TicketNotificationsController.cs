...
namespace BugTracker.Controllers
{
    public class TicketNotificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,RecipentId,SenderId,Created,Subject,NotificationBody,IsRead")] TicketNotification ticketNotification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,RecipentId,SenderId,Created,Subject,NotificationBody,IsRead")] TicketNotification ticketNotification)
        {
            if (ModelState.IsValid)
            {
